...
--
-- Host: localhost
-- Generation Time: Jun 11, 2016 at 08:34 PM
...
(40, 'mailchimp', 'root', 0, 'MailChimp', 'MailChimp', 'mailchimp/MailChimpDashboard.php', '', 'bAll', NULL, 0, 0, NULL, 0, 5, 'fa-envelope'),
...
(111, 'register', 'admin', 0, 'Register ChurchCRM', 'Update registration', 'Register.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 12, NULL),
(112, 'sms', 'root', 1, 'Send SMS', 'Send SMS', '', '', 'bAll', NULL, 0, 0, NULL, 1, 1, 'fa-envelope'),
(113, 'send1', 'sms', 0, 'Send To 1 person', 'Send To 1 person', 'sms/singlesms.php', '', 'bAll', NULL, 0, 0, NULL, 1, 2, NULL),
(114, 'sendmany', 'sms', 0, 'Send to Group', 'Send to Group', 'sms/sendgroup.php', '', 'bAll', NULL, 0, 0, NULL, 1, 3, NULL),
(115, 'receivesms', 'sms', 0, 'Received SMS', 'Received SMS', 'sms/received.php', '', 'bAll', NULL, 0, 0, NULL, 1, 4, NULL),
(116, 'sendsms', 'sms', 0, 'Sent SMS', 'Sent SMS', 'sms/send.php', '', 'bAll', NULL, 0, 0, NULL, 1, 5, NULL);
